...
public class RecentINRBean {
	...
	public RecentINRBean(String LabEntriesParamValue,Date LabEntriesParamDate,Integer LabParameterCodeParamid,String LabParameterCodeValue){
