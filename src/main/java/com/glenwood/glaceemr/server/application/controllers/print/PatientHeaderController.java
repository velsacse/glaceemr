...
public class PatientHeaderController {
	...
	public List<PatientHeader> fetchPatientHeaderList() throws Exception{
	...
	public List<PatientHeaderDetails> fetchPatientHeaderDetailsList(@RequestParam(value="headerId") Integer headerId,@RequestParam(value="pageId") Integer pageId) throws Exception{
	...
	public PatientHeader savePatientHeader(@RequestParam(value="headerName") String headerName,@RequestParam(value="headerType") Integer headerType,
	...
	public PatientHeader updatePatientHeader(@RequestParam(value="headerName") String headerName,@RequestParam(value="headerType") Integer headerType,
