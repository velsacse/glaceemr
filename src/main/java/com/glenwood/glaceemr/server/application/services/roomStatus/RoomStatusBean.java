...
public class RoomStatusBean {
	...
	public RoomStatusBean(Short roomId,Integer posId,String posName,String serName,String patName,Integer patId,String refName,Integer alertEventCategoryId,String checkIn_date, String qwt) {
        super();
		this.roomId = roomId;
		this.posId = posId;
	...
	public RoomStatusBean(Integer patId,String patName){
		super();
		this.patId = patId;
		this.patName = patName;
	}
