...
public void setHashString(String hashable)
{
  ...
  try {
      buf = hashable.getBytes();
      update(buf, hashable.length());
      } catch (Exception ex) {    ex.printStackTrace();       }
      md5final(out);
  lenghtofhash   = hashable.length();
  this.hashable = dumpBytes(out);
}
...
public static void main(String args[]) {
  MD5 md5 = new MD5();
  md5.setHashString("0");
//  GlaceOutLoggingStream.console(md5.getHashString());
  }
*/

	/////////////////////////////////////////////////////////////////////
	// Below here u will only find private functions                 //
	/////////////////////////////////////////////////////////////////////
